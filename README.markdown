...
####Updates
- Ruby version has moved [here](https://github.com/dorkitude/tagalog.rb).  For the time being, the Python and PHP versions still lounge hereabouts in a cuddle puddle.
